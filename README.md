...
- UI 100% custom (tema neon hijau/cyan/magenta), bukan webview
- Icon aplikasi sendiri, muncul di home screen kayak app biasa
- File hasil download masuk ke folder `Download/CyberDL` di HP
...
- Aplikasi ini pakai layanan pihak ketiga publik untuk mengambil link video tanpa watermark. Kalau sewaktu-waktu layanan itu berubah format responsnya, proses resolve bisa gagal — kabari saya kalau itu terjadi, gampang diperbaiki di `TikTokApi.kt`.
